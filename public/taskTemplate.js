...
templates['task'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"task\" data-time=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"points") || (depth0 != null ? lookupProperty(depth0,"points") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"points","hash":{},"data":data,"loc":{"start":{"line":3,"column":117},"end":{"line":3,"column":127}}}) : helper)))
    + " points)</span>\r\n    </div>\r\n</div>";
},"useData":true});
})();